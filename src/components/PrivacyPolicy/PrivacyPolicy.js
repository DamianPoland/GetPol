        ...
        <section className={style.background}>
            <div className={style.privacyContainer}>
                ...
                <div>
                    ...
                    <ol>
                        <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>getpol.com.pl</b></li>
                        <li>Operatorem serwisu oraz Administratorem danych osobowych jest: GETPOL GRZEGORZ ŻYNDA ul. Wawelska 33/6 80-034 Gdańsk NIP: 9570575239</li>

                        <li>Adres kontaktowy poczty elektronicznej operatora: biuro@getpol.com.pl</li>
